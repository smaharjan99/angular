  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>109/142</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>109/138</span>
      </div>
    </div>
  </div>
...
function isExternalStackEntry (entry) {
  return (entry ? true : <span class="branch-1 cbranch-no" title="branch not covered" >false)</span> &amp;&amp;
...
&nbsp;
  ...
  // should be relevant.
  <span class="missing-if-branch" title="if path not taken" >I</span>if (filteredStack.length === 0) {
<span class="cstat-no" title="statement not covered" >    filteredStack = stack</span>
  }
&nbsp;
  for (i = 0; i &lt; filteredStack.length; i += 1) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (filteredStack[i]) {
...
function formatFailedStep (step) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!step.stack) { <span class="cstat-no" title="statement not covered" >return step.message; </span>}
&nbsp;
  var relevantMessage = []
  var relevantStack = []
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (relevantMessage.length === 0) {
